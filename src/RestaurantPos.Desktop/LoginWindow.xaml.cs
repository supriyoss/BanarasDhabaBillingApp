...
public partial class LoginWindow : Window
{
    ...
    public LoginWindow(IServiceScopeFactory scopeFactory, UserSession session) { InitializeComponent(); this.scopeFactory = scopeFactory; this.session = session; Loaded += LoadUsers; }
